...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='Launch Site', 
        title='Successful launches from different sites')
        return fig
    else:
...
def get_scatter_chart(entered_site, payload):
    ...
    if entered_site == 'ALL':
        ...
        title='Launch outcomes of different Boosters with different payloads')
        return fig
    else:
        ...
        y='class', 
        color='Booster Version Category', 
        title='Launch outcomes of different Boosters with different payloads from site '+entered_site)
        return fig
